            ...
            <div className="hidden lg:flex lg:w-[45%] auth-gradient-bg relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col justify-center px-12 text-white">
                    ...
                    <h2 className="text-3xl font-bold mb-4 leading-tight">
                        Start your journey to<br />academic success.
                    </h2>
                    <p className="text-white/70 mb-10 text-sm leading-relaxed max-w-md">
                        Join students who use AcademiQ to stay organized, track progress, and ace their exams with AI.
                    </p>
                    <div className="space-y-4">
                        {[
                            { icon: BookOpen, text: "Organize subjects & resources" },
                            { icon: Clock, text: "Track study sessions" },
                            { icon: BarChart3, text: "Monitor your performance" },
                        ].map((item, i) => (
            ...
            <div className="flex-1 flex items-center justify-center p-6 bg-background">
                <div className="w-full max-w-sm">
                    <div className="lg:hidden flex items-center gap-2.5 mb-8">
                        ...
                        <span className="text-lg font-semibold text-foreground">Semester Manager</span>
                    </div>

                    <h1 className="text-2xl font-semibold text-foreground mb-1">Create account</h1>
                    <p className="text-sm text-muted-foreground mb-8">Enter your details to get started</p>
